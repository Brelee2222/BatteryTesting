...
async function getCurrentEvent(teamNumber) {
    currentTeamsEventMatches[teamNumber] = await (requestGetTBA(`https://thebluealliance.com/api/v3/team/frc${teamNumber}/event/2024orore/matches/key`).then(res => res.json()));
